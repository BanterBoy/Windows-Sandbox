...
#### CopyPsProfile
*Optional*. If supplied your Powershell profile will be copied to the sandbox. Your profile is assumed to be the $PROFILE environemnt variable in your current session, unless overriden using the CustomePsProfile parameter.
